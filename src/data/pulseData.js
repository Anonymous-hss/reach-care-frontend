...
export const pulseActionPages = {
  'turkana-maternal-mortality': {
    ...
    exportBrief: {
      brand: 'ReachCare',
      shortTitle: 'Turkana mortality brief',
      totalPages: 4,
      confidential: 'Decision Brief - CONFIDENTIAL',
      generatedAt: 'Generated May 11, 2026',
      footer: {
        preparedFor: 'Prepared for Priya Rao, Strategy Lead',
        sourceData: 'Source data: Kenya MoH Q1 2026, WHO AFRO, UNICEF Turkana',
        projections: 'All projections derived from WHO AFRO regional field data and Kenya MoH historical baselines.',
        generatedBy: 'Generated by ReachCare - Decision Intelligence Platform',
        url: 'reachcare.io/brief/turkana-mmr-may2026',
      },
      coverMetrics: [
        { label: 'Current MMR', value: '594', detail: '/ 100k' },
        { label: 'Pregnancies at risk', value: '~31,200' },
        { label: 'Affected population', value: '926k' },
        { label: 'Clinics closed', value: '14 / 47' },
      ],
      decision: {
        label: 'Decision required',
        body: 'Three response options identified for committee review. Total response budget range: $1.8M - $3.2M. Recommended timeline: decision within 4 weeks given drought conditions.',
      },
      situation: {
        title: 'The situation',
        body: 'After three years of relative stability, Q1 2026 data shows maternal mortality in Turkana and Marsabit counties climbing sharply above both the national average (530) and the regional baseline. The signal is consistent across three independent data sources, with a quality-weighted confidence of 0.91.',
        noteLabel: 'Why now',
        note: 'East Africa is in its fifth consecutive failed rainy season. Pastoralist displacement has accelerated since January, and 14 of 47 health facilities have closed due to staff and supply disruption.',
      },
      optionsTitle: 'Three options for committee review',
      optionsIntro:
        "Options are non-exclusive. The platform recommends a combined response weighted toward option 1, but the trade-offs below should be discussed against your organization's priorities.",
      options: [
        {
          label: 'Option 1 - Recommended',
          title: 'Mobile CHW deployment',
          body: 'Mobile maternal care units for pastoralist regions. WHO AFRO field data suggests 31-43% MMR reduction within 12 months.',
          meta: ['Projected reduction 31-43%', 'Timeline 12 months', 'Risk Med'],
          cost: '$1.8M',
          recommended: true,
        },
        {
          label: 'Option 2',
          title: 'Clinic reopening partnership',
          body: 'Reopen 8 of 14 closed facilities in partnership with Kenya MoH. Slower deployment but more durable infrastructure.',
          meta: ['Projected reduction 22%', 'Timeline 18 months', 'Risk Low'],
          cost: '$3.2M',
        },
        {
          label: 'Option 3',
          title: 'Referral-tier midwife placement',
          body: 'Station 24 skilled birth attendants at district hubs. Slower onset but builds long-term workforce capacity.',
          meta: ['Projected reduction 19%', 'Timeline 24 months', 'Risk Low'],
          cost: '$2.4M',
        },
      ],
      optionsNote:
        'Decision intelligence note - This brief presents options; your committee chooses the path. Each option includes traceable evidence on page 4 to support the conversation.',
      evidenceTitle: 'Evidence trail - 7 sources',
      evidenceIntro:
        "Every claim in this brief traces back to one of the following sources. Quality scores are assigned by the platform's validation agent based on peer review, recency, methodology, and corroboration.",
      evidence: [
        { score: '0.96', title: 'Kenya MoH Quarterly Bulletin - Q1 2026', meta: 'Government - Primary source - Published May 11, 2026' },
        { score: '0.91', title: 'WHO AFRO - Horn of Africa Drought Health Impact', meta: 'Multilateral - Field report - April 2026' },
        { score: '0.84', title: 'UNICEF - Turkana Field Assessment', meta: 'NGO - Field report - April 2026' },
        { score: '0.89', title: 'World Bank - Kenya Health Equity Indicators', meta: 'Multilateral - Annual indicators - 2025' },
        { score: '0.82', title: 'Lancet Global Health - CHW efficacy in pastoralist regions', meta: 'Peer-reviewed - January 2026' },
        { score: '0.78', title: 'DHS Kenya - 2024 demographic survey', meta: 'Survey data - Released October 2025' },
        { score: '0.74', title: 'FEWS NET - East Africa drought monitor', meta: 'Early warning system - Rolling update' },
      ],
      methodologyTitle: 'Methodology',
      methodology:
        "Projections combine WHO AFRO field data on mobile CHW efficacy with Kenya MoH historical baselines, weighted by source quality scores. The reasoning agent flagged this signal at relevance 94/100 due to alignment with focus markets and active investment exposure. Full methodology and validation logs available in the platform's Evidence library.",
    },
  },
  'dhaka-dengue-count': {
    type: 'model-impact',
    ...
    mitigations: [
      ...
      { title: 'Rebalance to unaffected regions', body: 'Pause Dhaka expansion; redirect $200k to Sylhet and Kenya programs operating at capacity.', cost: '$0 net', preserved: '1,800 of 2,400', unitCostLabel: 'Trade-off', unitCost: 'Slower Bangladesh growth' },
    ],
    note:
    ...
    allocations: [
      ...
      },
      {
        ...
        rows: [
          ...
          { label: 'Northeast Brazil', amount: '$2.4M', share: '30%', delta: '+$0.8M', value: 30 },
